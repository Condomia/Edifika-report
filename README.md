  ...
  <tbody>
    <tr>
      ...
      <td>
		...
		TB3: <br>Actualicé y apliqué conocimientos de desarrollo backend durante la implementación del microservicio de reservas, desarrollando y documentando una API REST con Swagger para garantizar una adecuada gestión y comunicación de los servicios del proyecto. <br><br>
		...
		TB3: Investigué y apliqué conocimientos sobre arquitectura de microservicios para implementar el API Gateway de Edifika utilizando Spring Cloud Gateway. Esto incluyó la configuración de políticas CORS para permitir la comunicación entre el frontend y los microservicios, la implementación de filtros de seguridad para validar tokens JWT en cada solicitud entrante y la definición de reglas de enrutamiento para direccionar las peticiones hacia los microservicios correspondientes según la ruta solicitada.<br><br>
      ...
      <td>
		...
		TB3: El equipo avanzó significativamente en la implementación del sistema Edifika, concretando el desarrollo de los microservicios de Reservas y Residential Management, la configuración del API Gateway como punto de entrada centralizado y la construcción de secciones del frontend de la aplicación. Cada integrante actualizó sus conocimientos técnicos según el componente asignado, abarcando desde la comunicación entre microservicios y validación de tokens JWT en el gateway, hasta el manejo de frameworks frontend y la persistencia de datos en servicios independientes, demostrando la capacidad del equipo para incorporar nuevas tecnologías conforme lo exige la evolución del proyecto. <br><br>
      </td>
    </tr>
    <tr>
      ...
      <td>
		...
		TB3: <br>Reconocí la necesidad de actualizar continuamente mis conocimientos en desarrollo backend, APIs REST y documentación con Swagger para implementar de manera adecuada el microservicio de reservas y responder a los requerimientos técnicos del proyecto. <br><br>
        Bejarano Martinez, Alvaro Leandro <br><br>
		...
		TB3: Reconocí que implementar un API Gateway funcional requiere comprender en profundidad cómo interactúan los componentes de una arquitectura distribuida. Configurar los filtros de seguridad, definir las políticas de CORS y establecer el enrutamiento dinámico fueron tareas que me exigieron investigar documentación de Spring Cloud Gateway, resolver conflictos entre configuraciones de seguridad y entender el ciclo de vida de una solicitud HTTP a través de múltiples servicios, confirmando que cada nuevo componente del sistema demanda aprendizaje técnico específico que solo se adquiere enfrentando el problema directamente. <br><br>
        Sarmiento Medina, Loreley <br><br>
...
<br>
		  TB3: La implementación simultánea de múltiples microservicios, el API Gateway y el frontend evidenció que el desarrollo de un sistema distribuido plantea desafíos técnicos continuos que no pueden resolverse con conocimientos estáticos. Coordinar el enrutamiento entre servicios, garantizar la seguridad transversal mediante filtros JWT, gestionar bases de datos independientes y construir interfaces que consuman correctamente los endpoints obligó a cada miembro del equipo a investigar, experimentar y adaptarse constantemente, reafirmando que el aprendizaje permanente es el pilar que sostiene la calidad y coherencia de un proyecto de ingeniería de software a medida que crece en complejidad. <br><br>
      </td>
    </tr>
  </tbody>
</table>
