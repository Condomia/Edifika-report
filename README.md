    ...
    <tr>
      ...
      <td>
        ...
        Avance 1: <br>Reconocí la importancia del aprendizaje continuo al desarrollar los cuadros As-Is, To-Be, el Impact Map y la entrevista, lo que me permitió mejorar mi análisis del usuario y comprender mejor cómo estructurar soluciones alineadas a sus necesidades reales.<br><br>
		  TB1: <br>A partir del desarrollo del capítulo 4, reconocí la importancia del aprendizaje continuo para comprender conceptos clave de arquitectura de software y su aplicación en un caso real. La necesidad de investigar sobre estilos arquitectónicos, decisiones de diseño y atributos de calidad evidenció que el aprendizaje permanente es fundamental para desarrollar soluciones técnicas sólidas y bien fundamentadas.<br><br>
        Zegarra López, Renato Sebastián Rubber <br><br>
